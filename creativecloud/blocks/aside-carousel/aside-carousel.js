...
const MOBILE_TEXT_SIZES = ['xl', 'm', 'm'];
const DESKTOP_TEXT_SIZES = ['xl', 'l', 'm'];
...
function decorateSlide(slide) {
  ...
  if (textCell) {
    const sizes = DESKTOP_MQ.matches ? DESKTOP_TEXT_SIZES : MOBILE_TEXT_SIZES;
    decorateBlockText(textCell, sizes);
  }
