export default class fragmentreference {
  constructor(page) {
    ...
    this.fragmentProduct1 = this.fragmentSection.locator('//merch-card[contains(@name, "CC Mini Compare: Single App: Individuals")]');
    this.fragmentProduct2 = this.fragmentSection.locator('//merch-card[contains(@name, "CC Mini Compare: Creative Cloud Pro: Individuals")]');
  }
}
