  ...
  features: [
    {
      tcid: '0',
      name: '@merchcard-ui',
      path: '/creativecloud/animation/testdoc/automation-pw/merchcard?georouting=off',
    ...
    },
    {
      ...
      path: '/creativecloud/animation/testdoc/automation-pw/pricefragments?georouting=off',
